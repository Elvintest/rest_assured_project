 ...
 */
public class BlockRepresentativeIP {
     ...
     */
    private final SelenideElement lastName = $(By.xpath("//input[@name = 'ip.representative.lastName']"));
    /**
     * Имя представителя
     */
    private final SelenideElement firstName = $(By.xpath("//input[@name = 'ip.representative.firstName']"));
    /**
     * отчество представителя
     */
    private final SelenideElement patronymic = $(By.xpath("//input[@name = 'ip.representative.patronymic']"));
    /**
     * Должность представителя
     */
    private final SelenideElement post = $(By.xpath("//input[@name = 'ip.representative.post']"));
    /**
     * Должность представителя
     */
    private final SelenideElement phone = $(By.xpath("//input[@name = 'ip.representative.phone']"));
    /**
     ...
     */
    private final SelenideElement docNumber = $(By.xpath("//input[@name = 'ip.representative.authorityDocument.docNumber']"));
    /**
