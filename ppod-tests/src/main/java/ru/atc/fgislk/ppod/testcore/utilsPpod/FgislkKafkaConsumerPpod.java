...
public class FgislkKafkaConsumerPpod {
     ...
     * @param consumerGroup
     */
    public FgislkKafkaConsumerPpod(String stend, String topic, String consumerGroup) {
     ...
     * @param duration
     */
    public FgislkKafkaConsumerPpod(String stend, String topic, String consumerGroup, Duration duration) {
