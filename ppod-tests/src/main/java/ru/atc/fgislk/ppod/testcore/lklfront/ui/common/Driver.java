...
//        Configuration.proxyEnabled = true; // Запускаемый встроенный proxy
...
//        Configuration.headless = true;
        ...
        switch (TestConfig.browser) {
            case "chrome":
                String pathCriptopFolder = Objects.requireNonNull(Driver.class.getClassLoader().getResource("plugins/CryptoPro")).getPath().substring(1);
                ChromeOptions options = new ChromeOptions();
                options.addArguments("load-extension=" + pathCriptopFolder);
...
//        open(configStatement.getStend().getServerFront());
